...
NodeWave Backend adalah layanan API untuk upload file Excel, memprosesnya secara asynchronous menggunakan BullMQ (Redis Queue), menyimpan hasil parsing ke database menggunakan Prisma + PostgreSQL, dan menyediakan sistem logging serta retry job.
